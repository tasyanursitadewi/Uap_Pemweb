			...
			<div class="col-md-6 col-sm-6 ">
				<div class="btn-group" data-toggle="buttons">
					<label class="btn btn-secondary" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
						<input type="radio" class="join-btn" name="Jenis_Kelamin" value="Laki-Laki"
						<?php if ($data['Jenis_Kelamin'] == 'Laki-Laki') {echo 'checked';} ?>
						required>Laki-Laki
					</label>
					<label class="btn btn-primary" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
						<input type="radio" class="join-btn" name="Jenis_Kelamin" value="Perempuan"
		...
		<div class="item form-group">
			...
			<div class="col-md-6 col-sm-6">
				<select name="Program_Studi" class="form-control" required>
					...
					<?php if ($data['Program_Studi'] == 'Ilmu Komputer') {
							echo 'selected';
							} ?>>Ilmu Komputer</option>
					<option value="Farmasi" <?php if ($data['Program_Studi'] == 'Farmasi') {
							echo 'selected';
							} ?>>Farmasi</option>
					<option value="Tata Kota" <?php if ($data['Program_Studi'] == 'Tata Kota') {
							echo 'selected';
							} ?>>Tata Kota</option>
					...
					<option value="Sosiologi" <?php if ($data['Program_Studi'] == 'Sosiologi') {
							echo 'selected';
							} ?>>Sosiologi</option>
