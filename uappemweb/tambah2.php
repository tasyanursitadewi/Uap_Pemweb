...
if (isset($_POST['submit'])) {
	...
	if (mysqli_num_rows($cek) == 0) {
		$sql = mysqli_query($koneksi, "INSERT INTO keluar (id, tanggal, nama, jenis, ukuran, harga, jumlah, total_harga) VALUES('$id', '$Tanggal', '$Nama', '$Jenis', '$Ukuran', '$Harga', '$Jumlah', '$Total_Harga')") or die(mysqli_error($koneksi));

		if ($sql) {
			echo '<script>alert("Berhasil menambahkan data."); document.location="utama.php?page=tampil2";</script>';
		} else {
...
<form action="utama.php?page=tambah2" method="post">
	...
	<div class="item form-group">
		...
		<div class="col-md-6 col-sm-6">
			<select name="jenis" class="form-control" required>
				...
				<option value="keluar Dalam">keluar Dalam</option>
			</select>
		</div>
	</div>
	<div class="item form-group">
